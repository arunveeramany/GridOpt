...
#define ARMA_AUX_LIBS /usr/lib64/libopenblaso.so;/usr/lib64/liblapack.so;/usr/lib64/libhdf5.so;/usr/lib64/libsz.so;/usr/lib64/libz.so;/usr/lib64/libdl.so;/usr/lib64/libm.so
